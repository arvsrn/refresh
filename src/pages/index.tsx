...
export default function Home() {
  const icons = [
    ...
    'database-locked','folder-locked','mic','megaphone','bell-cut','mic-cut','location-pin','map','heart','eraser','drop','input','animate','animation-enter','animation-exit','minus',
    'plus','bath','info','battery-charging','battery-empty','wifi','backpack'
  ].sort();
      ...
      <main className={styles.main}>
        <div className={styles.hero}>
          ...
          <p className={styles.copy}>
            New icons are added ~monthly. Follow on Twitter&nbsp;<a href="https://www.twitter.com/getrefreshd" className={styles.link}><span className={inter.className}>@</span>getrefreshd.</a> Made by&nbsp;<a href="https://www.twitter.com/arvsrn" className={styles.link}><span className={inter.className}>@</span>arvsrn</a>. Click the icons to copy as SVG.
          </p>
